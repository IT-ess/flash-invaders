<script lang="ts">
    import { BottomNav, BottomNavItem, Skeleton, ImagePlaceholder, Tooltip } from "flowbite-svelte"
</script>
...
<BottomNav position="absolute" navType="application" innerDiv="grid-cols-3">
